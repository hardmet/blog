...
<head>
    ...
    <link href='<c:url value="/resources/css/font-lora.css"/>' rel='stylesheet' type='text/css'>
    <link href='<c:url value="/resources/css/open-sans.css"/>' rel='stylesheet' type='text/css'>
    <link rel="stylesheet" href="<c:url value="/resources/css/jquery-ui.css"/>">
    <link rel="stylesheet" href="<c:url value="/resources/css/fix.css"/>">

    <jsp:invoke fragment="link"/><jsp:invoke fragment="link"/>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-offset-2 col-md-offset-1">
                    ...
                    <p class="copyright">Breath of freedom 2016
                        <br>
                        Авторы фотографий - <a class="footer-buttons" href="https://vk.com/id10052664" target="_blank">Dmitry Azanov</a>,

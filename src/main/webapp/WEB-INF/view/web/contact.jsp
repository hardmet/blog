...
<page:basePage>
    ...
    <jsp:body>
        ...
        <header class="intro-header">
            <img class="header-image" src="<c:url value="/img/contact-header.jpg"/>" height="300px">
        </header>
        <div class="titles">
            <h1>Contact Me</h1>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <ul class="list-unstyled list-inline list-social-icons">
                                <li>
                                    <a href="https://www.facebook.com/author.php?id=100012197762749"
                                       target="_blank"><i class="fa fa-facebook-square fa-2x"></i></a>
                                </li>
                                <li>
                                    <a href="https://www.linkedin.com/in/borisazanov" target="_blank">
                                        <i class="fa fa-linkedin-square fa-2x"></i></a>
                                </li>
                                <li>
                                    <a href="https://github.com/hardmet" target="_blank">

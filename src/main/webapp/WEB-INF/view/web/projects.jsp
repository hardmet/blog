    ...
    <jsp:body>
        ...
        <header class="intro-header">
            <img class="header-image"
                 src="${pageContext.request.contextPath}/img/projects-header.jpg" alt="">
        </header>
                        ...
                        <div class="gallery">
                            <div style="margin: 0 auto; width: 542px;">
                                <a class="fancybox-thumb" rel="fancybox-thumb"
                                   href="${pageContext.request.contextPath}/img/questaHome_login_scr.jpg"
                                   title="Экран входа в приложение">
                                    <img class="img-responsive"
                                         src="${pageContext.request.contextPath}/img/questaHome_login_scr.jpg"
                                         alt="">
                                </a>
                                <a class="fancybox-thumb" rel="fancybox-thumb"
                                   href="${pageContext.request.contextPath}/img/questaHome_main_menu.jpg"
                                   title="Экран главного меню">
                                    <img class="img-responsive"
                                         src="${pageContext.request.contextPath}/img/questaHome_main_menu.jpg"
                                         alt="">
                                </a>
                                <a class="fancybox-thumb" rel="fancybox-thumb"
                                   href="${pageContext.request.contextPath}/img/questaHome_userprofile.jpg"
                                   title="Панель профиля юзера">
                                    <img class="img-responsive"
                                         src="${pageContext.request.contextPath}/img/questaHome_userprofile.jpg"
                                         alt="">
                                </a>
                            </div>
                        </div>

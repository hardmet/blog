...
public class DAOImplTest {
    ...
    public void updateUser() {
        ...
        nativeQuery.setParameter(1, "newPass");
        nativeQuery.setParameter(2, "newName");
    ...
    @Test
    public void queryFindUserById() {
        System.out.println("ORMService queryFindUserById is called");
        assert (entityManager.find(User.class, userId).getEmail().equals("admin@gmail.com"));
        System.out.println(entityManager.find(User.class, userId).getEmail());
    }
    ...
    @Test
    public void queryFindAllUsersNames() {
        System.out.println("ORMService queryFindAllUsersNames is called");
        List resultList = entityManager.createQuery("SELECT U.email FROM User as U").getResultList();
        for (Object username:resultList) {
